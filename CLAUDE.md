...
- No external dependencies — uses only Apple frameworks (SwiftUI, Foundation, Security, Charts)
...
- **Services** (`DevinMobile/Services/`): `KeychainService` wraps Security framework for token/credential storage
